...
def reason_bq_sql_plan(
    ...
    *,
    ...
    system = (
        ...
        "Choose the fewest precise stg_* tables needed to answer the user question. "
        "Never invent table names outside the provided index. "
        "Prefer companions and joins listed in each table's semantic_relationships (rels=) "
        "when enriching context with multiple tables; never invent joins outside the YAML. "
        "Prefer fewer queries over speculative multi-table scans. "
