...
src as (
    select *
    from {{ ref('stg_ilri_vegetation_feed') }}
    ...
    qualify e.exact_geo_key is not null
        or row_number() over (
            partition by
                ...
                coalesce(e.household_id, ''),
                coalesce(cast(e.survey_date as string), ''),
                coalesce(e.record_type, ''),
...
select
    ...
    n.quantity_shrubs,
    n.quantity_grass,
    n.palatability_trees,
    n.palatability_shrubs,
    n.palatability_grass,
    n.carrying_capacity,
    n.currently_grazing,
    n.household_id,
    n.agro_climatic_zone_id,
    n.record_type,
