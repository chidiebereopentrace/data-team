...
with base as (
    select
        ...
        herd_size_cat,
        herd_size_cat_new,
        safe_cast(ItmStartYear as int64) as insurance_start_year,
        safe_cast(itm_start_year as int64) as itm_start_year,
        safe_cast(ItmStartYearNew as int64) as insurance_start_year_new,
    ...
    select
        ...
        cast(null as int64) as insurance_start_year,
        cast(null as int64) as itm_start_year,
        cast(null as int64) as insurance_start_year_new,
        cast(VaccID as string) as vaccinator_id,
