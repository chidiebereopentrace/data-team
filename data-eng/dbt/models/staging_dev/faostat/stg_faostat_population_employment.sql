...
select
    {{ dbt_utils.generate_surrogate_key(['area_code', 'item_code', 'element_code', 'indicator_code', 'source_code', 'sex_code', 'year', 'source_natural_key']) }} as faostat_population_employment_sk,
    base.*
from base
