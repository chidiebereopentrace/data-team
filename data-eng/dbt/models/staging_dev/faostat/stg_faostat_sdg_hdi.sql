...
select
    {{ dbt_utils.generate_surrogate_key(['area_code', 'area_code_m49', 'item_code', 'food_value_code', 'industry_code', 'factor_code', 'release_code', 'census_year_code', 'element_code', 'year', 'source_natural_key']) }} as faostat_sdg_hdi_sk,
    base.*
from base
